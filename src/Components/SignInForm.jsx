        ...
        <Col className="col-12 shadow-lg rounded" md="8" xxl="6">
          ...
          <Row className="justify-content-center">
            ...
            <Form className="mb-4" onSubmit={formik.handleSubmit}>
                <h4 className="text-center mb-4">Please, enter the credentials</h4>
                ...
                <Form.Group className="mb-4">
                  <FloatingLabel label="repository" controlId="repository">
                    <Form.Control
                      ...
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.repository && formik.errors.repository}
                      placeholder="repository"
                      disabled={isFetching}
                      required
                    />
                    <Form.Control.Feedback tooltip type="invalid">{formik.errors.repository}</Form.Control.Feedback>
                  </FloatingLabel>
                </Form.Group>
                <Button type="submit" variant="outline-dark"  disabled={isFetching} className="w-100 mt-3 mb-3">Sign in</Button>
              </Form>
            </Col>
          </Row>
        </Col>
